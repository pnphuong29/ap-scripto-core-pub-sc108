...
alias rsyncvmsshare="ap_func_rsync -k"
alias rsyncr="ap_func_rsync -r"
# @$func $$ ap_func_rsync {
# ap_func_rsync [-dpuwrk] <domain/ip> <port> <user> <password> [--] *<src_path> <dst_path>
# Description
...
#   -k 		        Use /data1/vms/shares as <dst_path>
# Parameters
...
# }
ap_func_rsync() {
    local ap_opts_string=':d:p:u:w:rk'
    local ap_opt=''
    local ap_opt_r=0
    local ap_opt_k=0
    local ap_domain_ip=""
