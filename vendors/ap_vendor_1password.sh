...
ap_func_setup_1password() {
    ...
    if [ "${AP_OS_TYPE}" == "${AP_OS_TYPE_MACOS}" ]; then
        ...
        # brew install 1password-cli # Should not use 1password cli because it may expose security issues
        ...
        # sudo apt install 1password-cli # Should not use 1password cli because it may expose security issues
    fi
