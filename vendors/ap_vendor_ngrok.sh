...
ap_func_create_dirstruct_ngrok() {
    apshowmsginfo "Generate [ngrok] bash autocomplete\n"
...
ap_func_rm_dirstruct_ngrok() {
    apshowmsginfo "Remove [${AP_COMPLETIONS_DIR}/ap_completion_ngrok.bash]\n"
