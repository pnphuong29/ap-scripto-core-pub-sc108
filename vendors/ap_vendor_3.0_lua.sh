...
ap_func_create_dirstruct_lua() {
    apshowmsginfo "Generate [lua] bash autocomplete\n"
...
ap_func_rm_dirstruct_lua() {
    apshowmsginfo "Remove [${AP_COMPLETIONS_DIR}/ap_completion_luarocks.bash]\n"
...
ap_func_setup_lua() {
    ...
    apshowmsginfo "Install [lua] v${ap_lua_setup_version}\n"
